...
public class FundingPaymentContorller {
    ...
    @GetMapping("/fundingInfo/{fundingId}")
    FPay_fundingInfoVo getFundingInfo(@PathVariable("fundingId") long fundingId){
        FPay_fundingInfoVo fundingInfo = fundingpayservice.getFuningS(fundingId);
        return fundingInfo;
    }
