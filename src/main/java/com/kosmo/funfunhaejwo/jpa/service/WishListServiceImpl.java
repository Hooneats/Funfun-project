...
import com.kosmo.funfunhaejwo.jpa.repository.WishListRepo;
...
public class WishListServiceImpl implements WishListService{
    ...
    @Override
    public List<ProductListVo> getWishList(Long member_id) {
        List<ProductListVo> productListVo = new ArrayList<>();
        List<Product> productList = wishListRepo.findByWish(member_id);
